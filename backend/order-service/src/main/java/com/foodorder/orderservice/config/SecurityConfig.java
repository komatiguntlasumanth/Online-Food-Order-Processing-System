...
import com.foodorder.orderservice.security.JwtAuthFilter;
import com.foodorder.orderservice.security.UserDetailsServiceImpl;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // OTP endpoints — must be public so unauthenticated users can request OTPs
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Allow local dev servers, Netlify deployments, and ngrok tunnels
        configuration.setAllowedOriginPatterns(Arrays.asList(
            ...
            "https://*.ngrok.io"        // ngrok paid tunnels
        ));
