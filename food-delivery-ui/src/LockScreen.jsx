...
export default function LockScreen({ onUnlock }) {
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gradient-to-br from-[#ff7e5f] to-[#feb47b] backdrop-blur-sm">
      <div className="bg-white/30 backdrop-filter backdrop-blur-xl rounded-2xl shadow-xl p-8 max-w-md w-full mx-4 border border-black/10">
        ...
        <button
          onClick={onUnlock}
          className="w-full py-3 bg-[#fc8019] hover:bg-[#e07015] text-slate-900 font-semibold rounded-xl transition-colors shadow-md"
        >
          Unlock
        </button>
      </div>
